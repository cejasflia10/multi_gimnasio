...
<div class="contenedor">
    ...
    <form method="POST" action="guardar_venta_productos.php" onsubmit="return validarPago();">
        ...
        <input type="number" name="pago_debito" placeholder="💳 Tarjeta Débito" step="0.01" min="0">
        <input type="number" name="pago_credito" placeholder="💳 Tarjeta Crédito" step="0.01" min="0">
