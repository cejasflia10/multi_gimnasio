...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <?php else: ?>
        <div class="note">No hay evento activo en sesión.</div>
      <?php endif; ?>
      ...
      <p class="muted">
        Al ingresar te llevamos a tu panel con la URL <code>?juez_id=…</code> (no se guarda el juez en sesión), para que puedas abrir varias pestañas sin pisarte.
      </p>
    </div>
  </div>
</body>
