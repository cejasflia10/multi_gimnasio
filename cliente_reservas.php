...
$ya_reservo = $conexion->query("SELECT * FROM reservas WHERE turno_id = $id_turno AND cliente_id = $cliente_id");
if ($ya_reservo->num_rows > 0) {
    die("Ya reservaste este turno.");
}

// Guardar reserva
$conexion->query("INSERT INTO reservas (turno_id, cliente_id, fecha) VALUES ($id_turno, $cliente_id, CURDATE())");
