<?php
// NO ESPACIOS NI SALTOS ANTES DE ESTA LÍNEA
...
if ($membresia->num_rows === 0) {
    die("No tenés clases disponibles.");
}

$m = $membresia->fetch_assoc();
$id_membresia = $m['id'];

// Verificar si ya reservó ese turno hoy
...
// Guardar reserva
$conexion->query("
    INSERT INTO reservas (turno_id, cliente_id, fecha, fecha_reserva, estado) 
...
echo "<script>alert('✅ Reserva realizada correctamente'); window.location.href='cliente_turnos.php';</script>";
exit;
?>
