...
// Requisitos de tablas usados: clientes, asistencias, reservas_clientes, turnos_disponibles, progreso_cliente
...
// ========= Listado base (alumnos que tuvieron asistencias con este profe, útil como atajo) =========
$alumnos = [];
if ($q = $conexion->query("
  SELECT DISTINCT
    c.id,
